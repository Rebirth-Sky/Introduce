...
var app = new Vue({
    ...
    data: {
        ...
        skills:[
        	'熟练使用.NET及.NetCore进行项目开发,有多年的B/S,C/S项目经验',
        	'2.熟练使用Div+CSS、jQuery、javascript实现前端功能',
        	'3.熟练使用SQLServer、Oracl,MySQL,Mangodb等常用数据库',
        	'熟悉ES6规范及Node、Vue、React等前端框架，具备良好的学习能力',
        	'了解微服务、docker、微信小程序开发',
        	'良好的学习习惯,能够快速学习新技术并应用到实际项目'
        ],
        experiences:[
        {
        	company:'君安信科技有限公司',
        ...
        projects:[{
        	name:'国标车载GPS监控系统平台',
        	tools:'Microsoft Visual Studio + MangoDB',
        	period:'6个月',
        	responsibility:[
				'参与初期原型设计和表设计',
				'负责底层国标协议解析以及测试',
        	...
        	name:'好易档案管理系统国际版',
        	tools:'Microsoft Visual Studio 2008+sqlserver2005/Oracle 10.2g',
        	period:'3个月',
        	responsibility:[
				'进行项目多语言升级',
				'对后台页面所有的汉字信息进行多语言进行处理',
        	...
        	name:'仓储管理系统',
        	tools:'Microsoft Visual Studio+Sqlserver/eclipse + oracle',
        	period:'12个月',
        	responsibility:[
				'金蝶接口模块：只包含从金蝶导出数据部分；数据导入到金蝶部分功能关闭',
				'条形码标签打印模块：其中包含设备码和仪器号打印部',
